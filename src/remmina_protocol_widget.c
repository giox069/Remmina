...
void remmina_protocol_widget_open_connection(RemminaProtocolWidget* gp, RemminaFile* remminafile)
{
	...
	remmina_connection_window_message_panel_show(gp, "Executing external commands...", MESSAGE_PANEL_SPINNER, NULL, NULL);
	...
	remmina_connection_window_message_panel_show(gp, s, MESSAGE_PANEL_SPINNER, NULL, NULL);
	g_free(s);
